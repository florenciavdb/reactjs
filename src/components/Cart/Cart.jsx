  ...
  return (
    ...
    <div className={r.Container}>
      ...
      <div className={r.Container1}>
        <div className={r.box}>IMAGE</div>
        <div className={r.box}>PRODUCT</div>
        <div className={r.box}>QUANTITY</div>
        <div className={r.box}>PRICE</div>
        <div className={r.box}>TOTAL</div>
        <div className={r.box}>DELETE</div>
      </div>
